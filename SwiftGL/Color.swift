...
public func mix(_ a: Color, b: Color, t: Color)  -> Color {return mix(a, b: b, t: t.vec)}
public func mix(_ a: Color, b: Color, t: Vec4)   -> Color {return a + Color((b - a).vec * t)}
public func mix(_ a: Color, b: Color, t: Float) -> Color {return a + (b - a) * t}
